import { stationSet as stSet } from './stations.mjs'; // Import the stationSet
...
async function book_validator(params, class_instance) {
    ...
    if (!(Object.prototype.hasOwnProperty.call(params, "from") && typeof params.from === "string" && stSet.has(params.from))) { // Use Set.has()
        throw new TypeError("Invalid from parameter");
    }
    if (!(Object.prototype.hasOwnProperty.call(params, "boarding") && typeof params.boarding === "string" && stSet.has(params.boarding))) { // Use Set.has()
        params.boarding = params.from;
    }
    if (!(Object.prototype.hasOwnProperty.call(params, "to") && typeof params.to === "string" && stSet.has(params.to))) { // Use Set.has()
    ...
    if (Object.prototype.hasOwnProperty.call(params, "passengers") && Array.isArray(params.passengers) && params.passengers.length > 0 && params.passengers.length < 9) {
        ...
        for (const passenger of params.passengers) {
            ...
            if (Object.prototype.hasOwnProperty.call(passenger, "berth")) {
                if (!(typeof passenger.berth === "string" && ["LB", "MB", "UB", "SL", "SU", "SS", "WS"].includes(passenger.berth))) { // Removed duplicate "SU"
